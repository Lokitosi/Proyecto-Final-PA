 ...
 * @author andre
 */
@WebServlet(name = "deleteEdit", urlPatterns = {"/deleteEdit"})
public class deleteEdit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        EditorialJpaController edi = new EditorialJpaController(utx , emf);
        String respuesta = "La Editorial se ha eliminado con exito";
            try {
                edi.destroy(id);
            } catch (RollbackFailureException ex) {
                respuesta = "El usuario no se encuentra en la base de datos";
            } catch (Exception ex) {
